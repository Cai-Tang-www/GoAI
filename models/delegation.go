...
type Delegation struct {
	...
	ResumeExecutionAttempt int    `gorm:"not null;default:0"`
	ResumeLeaseOwner       string `gorm:"size:64;index"`
	ResumeLeaseClaimedAt   *time.Time
	ResumeLeaseHeartbeatAt *time.Time
	ResumeLeaseExpiresAt   *time.Time `gorm:"index"`
